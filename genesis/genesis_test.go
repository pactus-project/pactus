...
func TestGenesisTestNet(t *testing.T) {
	...
	assert.Equal(t, g.Accounts()[0].Balance(), int64(4200000000000000))

	expected, _ := crypto.HashFromString("2d58e7be3987696bbb6e8bb6dce39426940ae175666020f314d2fa15c4bed3bb")
