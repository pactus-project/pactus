	...
	tests := []struct {
		...
		},
		{
			raw: []byte{
				...
				0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10,
				0x11, 0x12, 0x13, 0x14, 0x15, // from as account address
				0x02, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18,
				0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20,
				0x21, 0x12, 0x23, 0x24, 0x25, // to
			...
			basicErr: BasicCheckError{
				Reason: "sender is not a validator address: pc1zqgpsgpgxquyqjzstpsxsurcszyfpx9q4350xtk",
			},
		},
		{
			raw: []byte{
				...
				0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20,
				0x21, 0x12, 0x23, 0x24, 0x25, // to as validator address
				0x80, 0x80, 0x80, 0x01, // amount
			},
			value:   0x200000,
			readErr: nil,
