...
func TestDecode(t *testing.T) {
	...
	/*
		{
			1: {
				...
				8: h'013BFC7DF5C9915C56E399FBE47BE7D25AEFF238B3'
			},
			2: {
	...
	*/
	d, _ := hex.DecodeString("")
	assert.NoError(t, b1.Decode(d))
	d2, _ := b1.Encode()
	assert.Equal(t, d, d2)

	// 
	expected1 := hash.CalcHash(d[2:225])
	assert.True(t, b1.HashesTo(expected1))

	expected2, _ := hash.FromString("a45494d7171153bf8993d5dc14a100aa2aacb6987bc0a5cc3324639d5a4c10ec")
