...
type BondTxController struct {
	view   *view.TxBondDialogView
	model  BondTxModel
	getPwd TxPasswordProvider
}

func NewBondTxController(
	view *view.TxBondDialogView,
	model BondTxModel,
	getPassword TxPasswordProvider,
) *BondTxController {
	return &BondTxController{view: view, model: model, getPwd: getPassword}
}
...
func (c *BondTxController) BindAndRun() {
