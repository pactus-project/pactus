...
func TestSendDecodingAndHash(t *testing.T) {
	d, _ := hex.DecodeString("")
	s, _ := hex.DecodeString("a7010102582008f7d9c21fdaa4a4147e60a0f3933c850b0c0d9af6b2a308c0a7b5639a7e49d603186e040a050106a30155018dfaf698d3889b13251529ff971277305fbf1f44025501bdd1540a13d82c38e5b4dfbd7b5b2bcab5fb5f29031864076774657374207478")
	h, _ := hash.FromString("62cbca70a50621980cd46a178d11c612d0c2717329f6140d5c4413e7537e325c")
	var trx Tx
...
func TestBondDecodingAndHash(t *testing.T) {
	d, _ := hex.DecodeString("")
	s, _ := hex.DecodeString("")
	h, _ := hash.FromString("f224cce883b05ecbf0d48e37e9468908aea0935bddf9a43d578b14d703638749")
	var trx Tx
	err := trx.UnmarshalCBOR(d)
	assert.NoError(t, err)
	d2, _ := trx.MarshalCBOR()
...
func TestSortitionDecodingAndHash(t *testing.T) {
	d, _ := hex.DecodeString("")
	s, _ := hex.DecodeString("")
	h, _ := hash.FromString("42ade5c3a5c52e954f33e17f73eda5fe6cbb82e51041b345f4fe83f09eb3d6ae")
	var trx Tx
	err := trx.UnmarshalCBOR(d)
	assert.NoError(t, err)
	d2, _ := trx.MarshalCBOR()
