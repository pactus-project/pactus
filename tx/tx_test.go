...
func TestSendDecodingAndHash(t *testing.T) {
	...
	h, _ := crypto.HashFromString("fb9864eb36508e69de50dc85e69746923bddcc4b4c189ba1147f09a7c38f4365")
	var trx Tx
...
func TestBondDecodingAndHash(t *testing.T) {
	...
	h, _ := crypto.HashFromString("de6aab10430fa115d59a72dbff5a046f8be9a200c1941106641a4b691a3bf0bc")
	var trx Tx
	err := trx.UnmarshalCBOR(d)
	assert.NoError(t, err)
	d2, _ := trx.MarshalCBOR()
