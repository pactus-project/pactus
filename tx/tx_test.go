...
func TestSendDecodingAndHash(t *testing.T) {
	...
	h, _ := hash.FromString("38ea1ad335bbfd84641a34b6af3332810aef8e52da08897273f187fd6059c50a")
	var trx Tx
...
func TestBondDecodingAndHash(t *testing.T) {
	...
	h, _ := hash.FromString("0beb43223b39e21e8c29afa70afa44bf7e6320c148e9c3cdd6feb4e00d6c460a")
	var trx Tx
	err := trx.UnmarshalCBOR(d)
	assert.NoError(t, err)
	d2, _ := trx.MarshalCBOR()
...
func TestSortitionDecodingAndHash(t *testing.T) {
	...
	h, _ := hash.FromString("656a4cb4ae6dc60e53196818e035147762b738500bc002a30a29820ac9d8f433")
	var trx Tx
	err := trx.UnmarshalCBOR(d)
	assert.NoError(t, err)
	d2, _ := trx.MarshalCBOR()
