...
func TestSendDecodingAndHash(t *testing.T) {
	d, _ := hex.DecodeString("")
	s, _ := hex.DecodeString("a701010244e4f59ccd03186e041903e8050106a3015501d75c059a4157d78f9b86741164037392de0fa53102550194f782f332649a4234b79216277e0b1594836313031903e8076c746573742073656e642d7478")
	h, _ := hash.FromString("e30a3230dd9d2d9fad6b1406c8e689598057771f502ad54da330272d2b45d716")
	var trx Tx
...
func TestBondDecodingAndHash(t *testing.T) {
	d, _ := hex.DecodeString("")
	s, _ := hex.DecodeString("")
	h, _ := hash.FromString("8ea794ef0bc0407527eef1727dfac6180505ec27090cbc60a3c77c136a86a7e8")
	var trx Tx
	err := trx.UnmarshalCBOR(d)
	assert.NoError(t, err)
	d2, _ := trx.MarshalCBOR()
...
func TestSortitionDecodingAndHash(t *testing.T) {
	d, _ := hex.DecodeString("")
	s, _ := hex.DecodeString("a601010244d712c7f503186e0400050306a2015501ccb2131a6465585355e952ed8fe1760b4c2dc3620258306c35ee9c9b5827cffc0623fcc312febf3745eb4a351517a66dbe88c0f11dd25e83456c0ee57b14553f466747d76a7b3e")
	h, _ := hash.FromString("ae9ed6dee68841b0a72b4b8782c369a536a461128e5d2695a6a436c93d68f279")
	var trx Tx
	err := trx.UnmarshalCBOR(d)
	assert.NoError(t, err)
	d2, _ := trx.MarshalCBOR()
