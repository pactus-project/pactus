...
func TestGoToChangeProposerFromPrepare(t *testing.T) {
	...
	td.addCPPreVote(td.consP, hash.UndefHash, 2, 0, 0, vote.CPValueYes, &vote.JustInitYes{}, tIndexX)
	td.addCPPreVote(td.consP, hash.UndefHash, 2, 0, 0, vote.CPValueYes, &vote.JustInitYes{}, tIndexY)
