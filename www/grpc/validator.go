...
func (zs *zarbServer) GetValidatorByNumber(ctx context.Context,
...
func (zs *zarbServer) GetValidator(ctx context.Context,
...
func (zs *zarbServer) GetValidators(ctx context.Context,
