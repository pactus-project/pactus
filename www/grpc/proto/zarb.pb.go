...
func (x *BlockResponse) GetHeight() int32 {
	if x != nil {
		return x.Height
	}
	return 0
...
func (x *BlockHashRequest) GetHeight() int32 {
	if x != nil {
		return x.Height
	}
	return 0
...
type BlockchainInfoResponse struct {
	...
	LastBlockHeight int32  `protobuf:"varint,1,opt,name=last_block_height,json=lastBlockHeight,proto3" json:"last_block_height,omitempty"`
...
func (x *BlockchainInfoResponse) GetLastBlockHeight() int32 {
	if x != nil {
...
var file_zarb_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x61, 0x73,
	...
	0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0f, 0x6c, 0x61, 0x73, 0x74, 0x42, 0x6c, 0x6f,
