...
var (
	filter_Zarb_GetBlock_0 = &utilities.DoubleArray{Encoding: map[string]int{"hash": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_Zarb_GetBlockHash_0(ctx context.Context, marshaler runtime.Marshaler, client ZarbClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Zarb_GetBlockHash_0(ctx context.Context, marshaler runtime.Marshaler, server ZarbServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq BlockHashRequest
	var metadata runtime.ServerMetadata
...
func RegisterZarbHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ZarbServer) error {
	...
	mux.Handle("GET", pattern_Zarb_GetBlockHash_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		forward_Zarb_GetBlockHash_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Zarb_GetBlock_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 2}, []string{"api", "block", "hash"}, ""))

	pattern_Zarb_GetBlockHash_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "block_hash", "height"}, ""))
...
var (
	...
	forward_Zarb_GetBlockHash_0 = runtime.ForwardResponseMessage
