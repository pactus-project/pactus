...
func (x *SEND_PAYLOAD) GetSender() []byte {
	if x != nil {
		return x.Sender
	}
	return nil
...
func (x *SEND_PAYLOAD) GetReceiver() []byte {
	if x != nil {
		return x.Receiver
	}
	return nil
...
func (x *BOND_PAYLOAD) GetSender() []byte {
	if x != nil {
		return x.Sender
	}
	return nil
...
func (x *BOND_PAYLOAD) GetValidator() []byte {
	if x != nil {
		return x.Validator
	}
	return nil
...
func (x *SORTITION_PAYLOAD) GetAddress() []byte {
	if x != nil {
		return x.Address
	}
	return nil
...
var file_payloads_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x72, 0x12, 0x16,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x73, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x12, 0x1c,
	0x0a, 0x09, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x09, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x14, 0x0a, 0x05,
