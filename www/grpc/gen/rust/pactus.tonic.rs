...
pub mod wallet_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn migrate_wallet(
            &mut self,
            request: impl tonic::IntoRequest<super::MigrateWalletRequest>,
        ) -> std::result::Result<
            tonic::Response<super::MigrateWalletResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("pactus.Wallet", "MigrateWallet"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod wallet_server {
    ...
    pub trait Wallet: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn migrate_wallet(
            &self,
            request: tonic::Request<super::MigrateWalletRequest>,
        ) -> std::result::Result<
            tonic::Response<super::MigrateWalletResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/pactus.Wallet/MigrateWallet" => {
                    #[allow(non_camel_case_types)]
                    struct MigrateWalletSvc<T: Wallet>(pub Arc<T>);
                    impl<
                        T: Wallet,
                    > tonic::server::UnaryService<super::MigrateWalletRequest>
                    for MigrateWalletSvc<T> {
                        type Response = super::MigrateWalletResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Wallet>::migrate_wallet(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = MigrateWalletSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
