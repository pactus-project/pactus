...
impl<'de> serde::Deserialize<'de> for ChainType {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            {
                match value {
                    "CHAIN_TYPE_MAINNET" => Ok(ChainType::Mainnet),
                    "CHAIN_TYPE_TESTNET" => Ok(ChainType::Testnet),
                    "CHAIN_TYPE_LOCALNET" => Ok(ChainType::Localnet),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }
...
impl serde::Serialize for GetBlockchainInfoResponse {
        ...
        S: serde::Serializer,
    {
        ...
        if self.chain_type != 0 {
            let v = ChainType::try_from(self.chain_type)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", self.chain_type)))?;
            struct_ser.serialize_field("chainType", &v)?;
        }
        if self.sync_progress != 0. {
            struct_ser.serialize_field("syncProgress", &self.sync_progress)?;
        }
        if self.blocks_left != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("blocksLeft", ToString::to_string(&self.blocks_left).as_str())?;
        }
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "chainType" | "chain_type" => Ok(GeneratedField::ChainType),
                            "syncProgress" | "sync_progress" => Ok(GeneratedField::SyncProgress),
                            "blocksLeft" | "blocks_left" => Ok(GeneratedField::BlocksLeft),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut chain_type__ = None;
                let mut sync_progress__ = None;
                let mut blocks_left__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::ChainType => {
                            if chain_type__.is_some() {
                                return Err(serde::de::Error::duplicate_field("chainType"));
                            }
                            chain_type__ = Some(map_.next_value::<ChainType>()? as i32);
                        }
                        GeneratedField::SyncProgress => {
                            if sync_progress__.is_some() {
                                return Err(serde::de::Error::duplicate_field("syncProgress"));
                            }
                            sync_progress__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
                        GeneratedField::BlocksLeft => {
                            if blocks_left__.is_some() {
                                return Err(serde::de::Error::duplicate_field("blocksLeft"));
                            }
                            blocks_left__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                ...
                Ok(GetBlockchainInfoResponse {
                    ...
                    chain_type: chain_type__.unwrap_or_default(),
                    sync_progress: sync_progress__.unwrap_or_default(),
                    blocks_left: blocks_left__.unwrap_or_default(),
                })
            }
        }
...
impl serde::Serialize for MigrateWalletRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("pactus.MigrateWalletRequest", len)?;
        if !self.wallet_name.is_empty() {
            struct_ser.serialize_field("walletName", &self.wallet_name)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for MigrateWalletRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MigrateWalletRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct pactus.MigrateWalletRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MigrateWalletRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut wallet_name__ = None;
                ...
                Ok(MigrateWalletRequest {
                    wallet_name: wallet_name__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("pactus.MigrateWalletRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MigrateWalletResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("pactus.MigrateWalletResponse", len)?;
        if !self.wallet_name.is_empty() {
            struct_ser.serialize_field("walletName", &self.wallet_name)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for MigrateWalletResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MigrateWalletResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct pactus.MigrateWalletResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MigrateWalletResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut wallet_name__ = None;
