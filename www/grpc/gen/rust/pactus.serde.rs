...
impl serde::Serialize for GetTransactionPoolRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("pactus.GetTransactionPoolRequest", len)?;
        if self.payload_type != 0 {
            let v = PayloadType::from_i32(self.payload_type)
                .ok_or_else(|| serde::ser::Error::custom(format!("Invalid variant {}", self.payload_type)))?;
            struct_ser.serialize_field("payloadType", &v)?;
...
impl<'de> serde::Deserialize<'de> for GetTransactionPoolRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetTransactionPoolRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct pactus.GetTransactionPoolRequest")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<GetTransactionPoolRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut payload_type__ = None;
                ...
                Ok(GetTransactionPoolRequest {
                    payload_type: payload_type__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("pactus.GetTransactionPoolRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetTransactionPoolResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("pactus.GetTransactionPoolResponse", len)?;
        if !self.txs.is_empty() {
            struct_ser.serialize_field("txs", &self.txs)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetTransactionPoolResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetTransactionPoolResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct pactus.GetTransactionPoolResponse")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<GetTransactionPoolResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut txs__ = None;
        ...
        deserializer.deserialize_struct("pactus.GetTransactionPoolResponse", FIELDS, GeneratedVisitor)
    }
}
