...
impl serde::Serialize for IsWalletLoadedRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("pactus.IsWalletLoadedRequest", len)?;
        if !self.wallet_name.is_empty() {
            struct_ser.serialize_field("walletName", &self.wallet_name)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for IsWalletLoadedRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = IsWalletLoadedRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct pactus.IsWalletLoadedRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<IsWalletLoadedRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut wallet_name__ = None;
                ...
                Ok(IsWalletLoadedRequest {
                    wallet_name: wallet_name__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("pactus.IsWalletLoadedRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for IsWalletLoadedResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("pactus.IsWalletLoadedResponse", len)?;
        if !self.wallet_name.is_empty() {
            struct_ser.serialize_field("walletName", &self.wallet_name)?;
        }
        if self.loaded {
...
impl<'de> serde::Deserialize<'de> for IsWalletLoadedResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = IsWalletLoadedResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct pactus.IsWalletLoadedResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<IsWalletLoadedResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut wallet_name__ = None;
                ...
                Ok(IsWalletLoadedResponse {
                    wallet_name: wallet_name__.unwrap_or_default(),
                    loaded: loaded__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("pactus.IsWalletLoadedResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ListWalletsRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if self.include_unloaded {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("pactus.ListWalletsRequest", len)?;
        if self.include_unloaded {
            struct_ser.serialize_field("includeUnloaded", &self.include_unloaded)?;
        }
        struct_ser.end()
    }
}
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "includeUnloaded" | "include_unloaded" => Ok(GeneratedField::IncludeUnloaded),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ListWalletsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut include_unloaded__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::IncludeUnloaded => {
                            if include_unloaded__.is_some() {
                                return Err(serde::de::Error::duplicate_field("includeUnloaded"));
                            }
                            include_unloaded__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(ListWalletsRequest {
                    include_unloaded: include_unloaded__.unwrap_or_default(),
                })
            }
        }
