...
func (x *GetPeerInfoResponse) GetMoniker() string {
	if x != nil {
		return x.Moniker
	}
	return ""
...
func (x *GetPeerInfoResponse) GetAgent() string {
	if x != nil {
		return x.Agent
	}
	return ""
...
func (x *GetPeerInfoResponse) GetPeerId() []byte {
	if x != nil {
		return x.PeerId
	}
	return nil
...
func (x *GetPeerInfoResponse) GetFlags() int32 {
	if x != nil {
		return x.Flags
	}
	return 0
...
func (x *GetPeerInfoResponse) GetHeight() uint32 {
	if x != nil {
		return x.Height
	}
	return 0
...
func (x *GetPeerInfoResponse) GetReceivedMessages() int32 {
	if x != nil {
...
func (x *GetPeerInfoResponse) GetInvalidMessages() int32 {
	if x != nil {
...
func (x *GetPeerInfoResponse) GetReceivedBytes() int32 {
	if x != nil {
...
var file_network_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0xaa, 0x02, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x50, 0x65, 0x65, 0x72, 0x49, 0x6e, 0x66,
	0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x6f, 0x6e,
	...
	0x79, 0x12, 0x14, 0x0a, 0x05, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05,
	...
	0x0d, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0x9f,
	...
	0x32, 0xa2, 0x01, 0x0a, 0x07, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x12, 0x4f, 0x0a, 0x0e,
	...
	0x0b, 0x47, 0x65, 0x74, 0x50, 0x65, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1a, 0x2e, 0x70,
	0x61, 0x63, 0x74, 0x75, 0x73, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x65, 0x65, 0x72, 0x49, 0x6e, 0x66,
	0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x70, 0x61, 0x63, 0x74, 0x75,
	0x73, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x65, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x42, 0x0a, 0x0e, 0x70, 0x61, 0x63, 0x74, 0x75, 0x73, 0x2e,
	0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x5a, 0x30, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_network_proto_depIdxs = []int32{
	...
	2, // 2: pactus.Network.GetPeerInfo:input_type -> pactus.GetPeerInfoRequest
	1, // 3: pactus.Network.GetNetworkInfo:output_type -> pactus.GetNetworkInfoResponse
	3, // 4: pactus.Network.GetPeerInfo:output_type -> pactus.GetPeerInfoResponse
