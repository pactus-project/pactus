...
var file_wallet_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x32, 0x84, 0x05, 0x0a, 0x06, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x12, 0x49, 0x0a,
...
var file_wallet_proto_goTypes = []interface{}{
	...
	(*GetTotalBalanceRequest)(nil),      // 14: pactus.GetTotalBalanceRequest
	(*GetTotalBalanceResponse)(nil),     // 15: pactus.GetTotalBalanceResponse
}
var file_wallet_proto_depIdxs = []int32{
	...
	14, // 5: pactus.Wallet.GetTotalBalance:input_type -> pactus.GetTotalBalanceRequest
	12, // 6: pactus.Wallet.SignRawTransaction:input_type -> pactus.SignRawTransactionRequest
	8,  // 7: pactus.Wallet.GetValidatorAddress:input_type -> pactus.GetValidatorAddressRequest
	1,  // 8: pactus.Wallet.CreateWallet:output_type -> pactus.CreateWalletResponse
	3,  // 9: pactus.Wallet.LoadWallet:output_type -> pactus.LoadWalletResponse
	5,  // 10: pactus.Wallet.UnloadWallet:output_type -> pactus.UnloadWalletResponse
	7,  // 11: pactus.Wallet.LockWallet:output_type -> pactus.LockWalletResponse
	11, // 12: pactus.Wallet.UnlockWallet:output_type -> pactus.UnlockWalletResponse
	15, // 13: pactus.Wallet.GetTotalBalance:output_type -> pactus.GetTotalBalanceResponse
	13, // 14: pactus.Wallet.SignRawTransaction:output_type -> pactus.SignRawTransactionResponse
	9,  // 15: pactus.Wallet.GetValidatorAddress:output_type -> pactus.GetValidatorAddressResponse
