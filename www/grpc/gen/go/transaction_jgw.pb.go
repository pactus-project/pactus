...
func (s *TransactionJsonRPC) Methods() map[string]func(ctx context.Context, message json.RawMessage) (any, error) {
	return map[string]func(ctx context.Context, params json.RawMessage) (any, error){
		...
		"pactus.transaction.get_transaction_pool": func(ctx context.Context, data json.RawMessage) (any, error) {
			req := new(GetTransactionPoolRequest)
			...
			return s.client.GetTransactionPool(metadata.NewOutgoingContext(ctx, jrpcData.Headers), req)
		},
	}
}
