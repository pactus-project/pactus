...
var file_blockchain_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x6f, 0x0a, 0x19, 0x47,
	...
	0x61, 0x73, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x61, 0x73, 0x68, 0x22, 0x9b, 0x02, 0x0a,
	...
	0x65, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03,
	...
	0x6a, 0x6f, 0x69, 0x6e, 0x65, 0x64, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x06, 0x20,
	...
	0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x75, 0x0a, 0x0b, 0x41, 0x63,
	...
	0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x83, 0x01, 0x0a, 0x0f, 0x43, 0x65, 0x72,
	0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x14, 0x0a, 0x05,
	...
	0x18, 0x02, 0x20, 0x03, 0x28, 0x05, 0x52, 0x0a, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65,
	0x72, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x62, 0x73, 0x65, 0x6e, 0x74, 0x65, 0x65, 0x73, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x05, 0x52, 0x09, 0x61, 0x62, 0x73, 0x65, 0x6e, 0x74, 0x65, 0x65, 0x73,
	0x12, 0x1c, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x2a, 0x48,
	...
	0x43, 0x54, 0x49, 0x4f, 0x4e, 0x53, 0x10, 0x02, 0x32, 0xfa, 0x04, 0x0a, 0x0a, 0x42, 0x6c, 0x6f,
...
var file_blockchain_proto_goTypes = []interface{}{
	...
	(*GetAccountRequest)(nil),           // 1: pactus.GetAccountRequest
	(*GetAccountResponse)(nil),          // 2: pactus.GetAccountResponse
	(*GetValidatorsRequest)(nil),        // 3: pactus.GetValidatorsRequest
	(*GetValidatorRequest)(nil),         // 4: pactus.GetValidatorRequest
	(*GetValidatorByNumberRequest)(nil), // 5: pactus.GetValidatorByNumberRequest
	(*GetValidatorsResponse)(nil),       // 6: pactus.GetValidatorsResponse
	(*GetValidatorResponse)(nil),        // 7: pactus.GetValidatorResponse
	(*GetBlockRequest)(nil),             // 8: pactus.GetBlockRequest
	(*GetBlockResponse)(nil),            // 9: pactus.GetBlockResponse
	(*GetBlockHashRequest)(nil),         // 10: pactus.GetBlockHashRequest
	(*GetBlockHashResponse)(nil),        // 11: pactus.GetBlockHashResponse
	(*GetBlockHeightRequest)(nil),       // 12: pactus.GetBlockHeightRequest
	(*GetBlockHeightResponse)(nil),      // 13: pactus.GetBlockHeightResponse
	(*GetBlockchainInfoRequest)(nil),    // 14: pactus.GetBlockchainInfoRequest
	(*GetBlockchainInfoResponse)(nil),   // 15: pactus.GetBlockchainInfoResponse
...
var file_blockchain_proto_depIdxs = []int32{
	17, // 0: pactus.GetAccountResponse.account:type_name -> pactus.AccountInfo
	16, // 1: pactus.GetValidatorsResponse.validators:type_name -> pactus.ValidatorInfo
	16, // 2: pactus.GetValidatorResponse.validator:type_name -> pactus.ValidatorInfo
	0,  // 3: pactus.GetBlockRequest.verbosity:type_name -> pactus.BlockVerbosity
	18, // 4: pactus.GetBlockResponse.header:type_name -> pactus.BlockHeaderInfo
	19, // 5: pactus.GetBlockResponse.prev_cert:type_name -> pactus.CertificateInfo
	20, // 6: pactus.GetBlockResponse.txs:type_name -> pactus.TransactionInfo
	8,  // 7: pactus.Blockchain.GetBlock:input_type -> pactus.GetBlockRequest
	10, // 8: pactus.Blockchain.GetBlockHash:input_type -> pactus.GetBlockHashRequest
	12, // 9: pactus.Blockchain.GetBlockHeight:input_type -> pactus.GetBlockHeightRequest
	14, // 10: pactus.Blockchain.GetBlockchainInfo:input_type -> pactus.GetBlockchainInfoRequest
	1,  // 11: pactus.Blockchain.GetAccount:input_type -> pactus.GetAccountRequest
	4,  // 12: pactus.Blockchain.GetValidator:input_type -> pactus.GetValidatorRequest
	5,  // 13: pactus.Blockchain.GetValidatorByNumber:input_type -> pactus.GetValidatorByNumberRequest
	3,  // 14: pactus.Blockchain.GetValidators:input_type -> pactus.GetValidatorsRequest
	9,  // 15: pactus.Blockchain.GetBlock:output_type -> pactus.GetBlockResponse
	11, // 16: pactus.Blockchain.GetBlockHash:output_type -> pactus.GetBlockHashResponse
	13, // 17: pactus.Blockchain.GetBlockHeight:output_type -> pactus.GetBlockHeightResponse
	15, // 18: pactus.Blockchain.GetBlockchainInfo:output_type -> pactus.GetBlockchainInfoResponse
	2,  // 19: pactus.Blockchain.GetAccount:output_type -> pactus.GetAccountResponse
	7,  // 20: pactus.Blockchain.GetValidator:output_type -> pactus.GetValidatorResponse
	7,  // 21: pactus.Blockchain.GetValidatorByNumber:output_type -> pactus.GetValidatorResponse
	6,  // 22: pactus.Blockchain.GetValidators:output_type -> pactus.GetValidatorsResponse
