...
type ValidatorInfo struct {
	...
	AvailabilityScore   float32 `protobuf:"fixed32,10,opt,name=availability_score,json=availabilityScore,proto3" json:"availability_score,omitempty"`
}
...
func (x *ValidatorInfo) GetAvailabilityScore() float32 {
	if x != nil {
...
var file_blockchain_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x72, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x02, 0x52, 0x11, 0x61, 0x76, 0x61, 0x69,
