...
const GetBlockchainInfoResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'blockchain_size', '3': 5, '4': 1, '5': 5, '10': 'blockchainSize'},
    const {'1': 'total_power', '3': 6, '4': 1, '5': 3, '10': 'totalPower'},
    const {'1': 'committee_power', '3': 7, '4': 1, '5': 3, '10': 'committeePower'},
    const {'1': 'committee_validators', '3': 8, '4': 3, '5': 11, '6': '.pactus.ValidatorInfo', '10': 'committeeValidators'},
  ],
};

/// Descriptor for `GetBlockchainInfoResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getBlockchainInfoResponseDescriptor = $convert.base64Decode('');
