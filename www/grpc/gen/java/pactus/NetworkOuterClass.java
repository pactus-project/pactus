...
public final class NetworkOuterClass extends com.google.protobuf.GeneratedFile {
  ...
  public enum Direction
    ...
    public static com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return pactus.NetworkOuterClass.getDescriptor().getEnumType(0);
    }
    ...
    private int computeSerializedSize_0() {
      ...
      if (((bitField0_ & 0x00000001) != 0)) {
        size += com.google.protobuf.CodedOutputStream
          ...
          {
            final int count = zmqPublishers_.size();
            for (int i = 0; i < count; i++) {
              size += com.google.protobuf.CodedOutputStream
                .computeMessageSizeNoTag(zmqPublishers_.get(i));
            }
            size += 1 * count;
          }
      if (currentTime_ != 0L) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 66: {
                ensureLocalAddrsIsMutable();
                localAddrs_.add(input.readStringRequireUtf8());
                break;
              } // case 66
              case 74: {
                ensureProtocolsIsMutable();
                protocols_.add(input.readStringRequireUtf8());
                break;
              } // case 74
              case 105: {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 42: {
                ensureConsensusKeysIsMutable();
                consensusKeys_.add(input.readStringRequireUtf8());
                break;
              } // case 42
              case 50: {
                ensureConsensusAddressesIsMutable();
                consensusAddresses_.add(input.readStringRequireUtf8());
                break;
              } // case 50
              case 56: {
