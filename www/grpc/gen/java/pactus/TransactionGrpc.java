...
public final class TransactionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<pactus.TransactionOuterClass.TransactionRequest,
      pactus.TransactionOuterClass.TransactionResponse> getGetTransactionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetTransaction",
      requestType = pactus.TransactionOuterClass.TransactionRequest.class,
      responseType = pactus.TransactionOuterClass.TransactionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<pactus.TransactionOuterClass.TransactionRequest,
      pactus.TransactionOuterClass.TransactionResponse> getGetTransactionMethod() {
    io.grpc.MethodDescriptor<pactus.TransactionOuterClass.TransactionRequest, pactus.TransactionOuterClass.TransactionResponse> getGetTransactionMethod;
      ...
      synchronized (TransactionGrpc.class) {
        if ((getGetTransactionMethod = TransactionGrpc.getGetTransactionMethod) == null) {
          TransactionGrpc.getGetTransactionMethod = getGetTransactionMethod =
              io.grpc.MethodDescriptor.<pactus.TransactionOuterClass.TransactionRequest, pactus.TransactionOuterClass.TransactionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetTransaction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pactus.TransactionOuterClass.TransactionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pactus.TransactionOuterClass.TransactionResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<pactus.TransactionOuterClass.SendRawTransactionRequest,
      pactus.TransactionOuterClass.SendRawTransactionResponse> getSendRawTransactionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendRawTransaction",
      requestType = pactus.TransactionOuterClass.SendRawTransactionRequest.class,
      responseType = pactus.TransactionOuterClass.SendRawTransactionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<pactus.TransactionOuterClass.SendRawTransactionRequest,
      pactus.TransactionOuterClass.SendRawTransactionResponse> getSendRawTransactionMethod() {
    io.grpc.MethodDescriptor<pactus.TransactionOuterClass.SendRawTransactionRequest, pactus.TransactionOuterClass.SendRawTransactionResponse> getSendRawTransactionMethod;
      ...
      synchronized (TransactionGrpc.class) {
        if ((getSendRawTransactionMethod = TransactionGrpc.getSendRawTransactionMethod) == null) {
          TransactionGrpc.getSendRawTransactionMethod = getSendRawTransactionMethod =
              io.grpc.MethodDescriptor.<pactus.TransactionOuterClass.SendRawTransactionRequest, pactus.TransactionOuterClass.SendRawTransactionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SendRawTransaction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pactus.TransactionOuterClass.SendRawTransactionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pactus.TransactionOuterClass.SendRawTransactionResponse.getDefaultInstance()))
  ...
  public static abstract class TransactionImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getTransaction(pactus.TransactionOuterClass.TransactionRequest request,
        io.grpc.stub.StreamObserver<pactus.TransactionOuterClass.TransactionResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetTransactionMethod(), responseObserver);
    }

    /**
     */
    public void sendRawTransaction(pactus.TransactionOuterClass.SendRawTransactionRequest request,
        io.grpc.stub.StreamObserver<pactus.TransactionOuterClass.SendRawTransactionResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                pactus.TransactionOuterClass.TransactionRequest,
                pactus.TransactionOuterClass.TransactionResponse>(
                  this, METHODID_GET_TRANSACTION)))
          .addMethod(
            getSendRawTransactionMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                pactus.TransactionOuterClass.SendRawTransactionRequest,
                pactus.TransactionOuterClass.SendRawTransactionResponse>(
  ...
  public static final class TransactionBlockingStub extends io.grpc.stub.AbstractBlockingStub<TransactionBlockingStub> {
    ...
    /**
     */
    public pactus.TransactionOuterClass.TransactionResponse getTransaction(pactus.TransactionOuterClass.TransactionRequest request) {
    ...
    /**
     */
    public pactus.TransactionOuterClass.SendRawTransactionResponse sendRawTransaction(pactus.TransactionOuterClass.SendRawTransactionRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class TransactionFutureStub extends io.grpc.stub.AbstractFutureStub<TransactionFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<pactus.TransactionOuterClass.TransactionResponse> getTransaction(
        pactus.TransactionOuterClass.TransactionRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<pactus.TransactionOuterClass.SendRawTransactionResponse> sendRawTransaction(
        pactus.TransactionOuterClass.SendRawTransactionRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_TRANSACTION:
          serviceImpl.getTransaction((pactus.TransactionOuterClass.TransactionRequest) request,
              (io.grpc.stub.StreamObserver<pactus.TransactionOuterClass.TransactionResponse>) responseObserver);
          break;
        case METHODID_SEND_RAW_TRANSACTION:
          serviceImpl.sendRawTransaction((pactus.TransactionOuterClass.SendRawTransactionRequest) request,
              (io.grpc.stub.StreamObserver<pactus.TransactionOuterClass.SendRawTransactionResponse>) responseObserver);
          break;
        default:
