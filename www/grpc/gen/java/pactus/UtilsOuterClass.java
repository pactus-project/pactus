...
public final class UtilsOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return pactus.UtilsOuterClass.internal_static_pactus_PingRequest_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return pactus.UtilsOuterClass.internal_static_pactus_PingRequest_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              pactus.UtilsOuterClass.PingRequest.class, pactus.UtilsOuterClass.PingRequest.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof pactus.UtilsOuterClass.PingRequest)) {
        return super.equals(obj);
      }
      pactus.UtilsOuterClass.PingRequest other = (pactus.UtilsOuterClass.PingRequest) obj;
    ...
    public static pactus.UtilsOuterClass.PingRequest parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static pactus.UtilsOuterClass.PingRequest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static pactus.UtilsOuterClass.PingRequest parseFrom(
    ...
    public static pactus.UtilsOuterClass.PingRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseWithIOException(PARSER, input);
    }
    ...
    public static pactus.UtilsOuterClass.PingRequest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static pactus.UtilsOuterClass.PingRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static Builder newBuilder(pactus.UtilsOuterClass.PingRequest prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        pactus.UtilsOuterClass.PingRequestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return pactus.UtilsOuterClass.internal_static_pactus_PingRequest_descriptor;
      }
      ...
      // Construct using pactus.UtilsOuterClass.PingRequest.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public pactus.UtilsOuterClass.PingRequest getDefaultInstanceForType() {
        return pactus.UtilsOuterClass.PingRequest.getDefaultInstance();
      }

      @java.lang.Override
      public pactus.UtilsOuterClass.PingRequest build() {
        pactus.UtilsOuterClass.PingRequest result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public pactus.UtilsOuterClass.PingRequest buildPartial() {
        pactus.UtilsOuterClass.PingRequest result = new pactus.UtilsOuterClass.PingRequest(this);
        onBuilt();
        return result;
      }
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof pactus.UtilsOuterClass.PingRequest) {
          return mergeFrom((pactus.UtilsOuterClass.PingRequest)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(pactus.UtilsOuterClass.PingRequest other) {
        if (other == pactus.UtilsOuterClass.PingRequest.getDefaultInstance()) return this;
        this.mergeUnknownFields(other.getUnknownFields());
        onChanged();
        return this;
      }
    ...
    private static final pactus.UtilsOuterClass.PingRequest DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new pactus.UtilsOuterClass.PingRequest();
    }

    public static pactus.UtilsOuterClass.PingRequest getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return pactus.UtilsOuterClass.internal_static_pactus_PingResponse_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return pactus.UtilsOuterClass.internal_static_pactus_PingResponse_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              pactus.UtilsOuterClass.PingResponse.class, pactus.UtilsOuterClass.PingResponse.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof pactus.UtilsOuterClass.PingResponse)) {
        return super.equals(obj);
      }
      pactus.UtilsOuterClass.PingResponse other = (pactus.UtilsOuterClass.PingResponse) obj;
    ...
    public static pactus.UtilsOuterClass.PingResponse parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static pactus.UtilsOuterClass.PingResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static pactus.UtilsOuterClass.PingResponse parseFrom(
    ...
    public static pactus.UtilsOuterClass.PingResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseWithIOException(PARSER, input);
    }
    ...
    public static pactus.UtilsOuterClass.PingResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static pactus.UtilsOuterClass.PingResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static Builder newBuilder(pactus.UtilsOuterClass.PingResponse prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        pactus.UtilsOuterClass.PingResponseOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return pactus.UtilsOuterClass.internal_static_pactus_PingResponse_descriptor;
      }
      ...
      // Construct using pactus.UtilsOuterClass.PingResponse.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public pactus.UtilsOuterClass.PingResponse getDefaultInstanceForType() {
        return pactus.UtilsOuterClass.PingResponse.getDefaultInstance();
      }

      @java.lang.Override
      public pactus.UtilsOuterClass.PingResponse build() {
        pactus.UtilsOuterClass.PingResponse result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public pactus.UtilsOuterClass.PingResponse buildPartial() {
        pactus.UtilsOuterClass.PingResponse result = new pactus.UtilsOuterClass.PingResponse(this);
        onBuilt();
        return result;
      }
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof pactus.UtilsOuterClass.PingResponse) {
          return mergeFrom((pactus.UtilsOuterClass.PingResponse)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(pactus.UtilsOuterClass.PingResponse other) {
        if (other == pactus.UtilsOuterClass.PingResponse.getDefaultInstance()) return this;
        this.mergeUnknownFields(other.getUnknownFields());
        onChanged();
        return this;
      }
    ...
    private static final pactus.UtilsOuterClass.PingResponse DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new pactus.UtilsOuterClass.PingResponse();
    }

    public static pactus.UtilsOuterClass.PingResponse getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "gnature\030\001 \001(\tR\tsignature\"\r\n\013PingRequest\"" +
      "\016\n\014PingResponse2\300\003\n\005Utils\022p\n\031SignMessage" +
      "WithPrivateKey\022(.pactus.SignMessageWithP" +
      "rivateKeyRequest\032).pactus.SignMessageWit" +
      "hPrivateKeyResponse\022L\n\rVerifyMessage\022\034.p" +
      "actus.VerifyMessageRequest\032\035.pactus.Veri" +
      "fyMessageResponse\022a\n\024PublicKeyAggregatio" +
      "n\022#.pactus.PublicKeyAggregationRequest\032$" +
      ".pactus.PublicKeyAggregationResponse\022a\n\024" +
      "SignatureAggregation\022#.pactus.SignatureA" +
      "ggregationRequest\032$.pactus.SignatureAggr" +
      "egationResponse\0221\n\004Ping\022\023.pactus.PingReq" +
      "uest\032\024.pactus.PingResponseB:\n\006pactusZ0gi" +
