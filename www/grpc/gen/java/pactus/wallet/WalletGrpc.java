...
public final class WalletGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<pactus.wallet.WalletOuterClass.GenerateMnemonicRequest,
      pactus.wallet.WalletOuterClass.GenerateMnemonicResponse> getGenerateMnemonicMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GenerateMnemonic",
      requestType = pactus.wallet.WalletOuterClass.GenerateMnemonicRequest.class,
      responseType = pactus.wallet.WalletOuterClass.GenerateMnemonicResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<pactus.wallet.WalletOuterClass.GenerateMnemonicRequest,
      pactus.wallet.WalletOuterClass.GenerateMnemonicResponse> getGenerateMnemonicMethod() {
    io.grpc.MethodDescriptor<pactus.wallet.WalletOuterClass.GenerateMnemonicRequest, pactus.wallet.WalletOuterClass.GenerateMnemonicResponse> getGenerateMnemonicMethod;
      ...
      synchronized (WalletGrpc.class) {
        if ((getGenerateMnemonicMethod = WalletGrpc.getGenerateMnemonicMethod) == null) {
          WalletGrpc.getGenerateMnemonicMethod = getGenerateMnemonicMethod =
              io.grpc.MethodDescriptor.<pactus.wallet.WalletOuterClass.GenerateMnemonicRequest, pactus.wallet.WalletOuterClass.GenerateMnemonicResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GenerateMnemonic"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pactus.wallet.WalletOuterClass.GenerateMnemonicRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pactus.wallet.WalletOuterClass.GenerateMnemonicResponse.getDefaultInstance()))
  ...
  public static abstract class WalletImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void generateMnemonic(pactus.wallet.WalletOuterClass.GenerateMnemonicRequest request,
        io.grpc.stub.StreamObserver<pactus.wallet.WalletOuterClass.GenerateMnemonicResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                pactus.wallet.WalletOuterClass.GenerateMnemonicRequest,
                pactus.wallet.WalletOuterClass.GenerateMnemonicResponse>(
  ...
  public static final class WalletBlockingStub extends io.grpc.stub.AbstractBlockingStub<WalletBlockingStub> {
    ...
    /**
     */
    public pactus.wallet.WalletOuterClass.GenerateMnemonicResponse generateMnemonic(pactus.wallet.WalletOuterClass.GenerateMnemonicRequest request) {
  ...
  public static final class WalletFutureStub extends io.grpc.stub.AbstractFutureStub<WalletFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<pactus.wallet.WalletOuterClass.GenerateMnemonicResponse> generateMnemonic(
        pactus.wallet.WalletOuterClass.GenerateMnemonicRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GENERATE_MNEMONIC:
          serviceImpl.generateMnemonic((pactus.wallet.WalletOuterClass.GenerateMnemonicRequest) request,
              (io.grpc.stub.StreamObserver<pactus.wallet.WalletOuterClass.GenerateMnemonicResponse>) responseObserver);
          break;
