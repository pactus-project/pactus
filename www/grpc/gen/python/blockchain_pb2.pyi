...
class GetBlockchainInfoResponse(_message.Message):
    __slots__ = ("last_block_height", "last_block_hash", "last_block_time", "total_accounts", "total_validators", "active_validators", "total_power", "committee_power", "is_pruned", "pruning_height", "in_committee", "committee_size", "average_score", "chain_type", "sync_progress", "blocks_left")
...
class GetCommitteeInfoResponse(_message.Message):
    __slots__ = ("committee_size", "committee_power", "total_power", "validators", "protocol_versions")
...
class ValidatorInfo(_message.Message):
    __slots__ = ("hash", "data", "public_key", "number", "stake", "last_bonding_height", "last_sortition_height", "unbonding_height", "address", "availability_score", "protocol_version", "is_delegated", "delegate_owner", "delegate_share", "delegate_expiry")
    HASH_FIELD_NUMBER: _ClassVar[int]
    DATA_FIELD_NUMBER: _ClassVar[int]
    PUBLIC_KEY_FIELD_NUMBER: _ClassVar[int]
    NUMBER_FIELD_NUMBER: _ClassVar[int]
