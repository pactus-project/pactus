...
goog.exportSymbol('proto.pactus.FeeConfig', null, global);
 ...
 * @constructor
 */
proto.pactus.FeeConfig = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pactus.FeeConfig, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pactus.FeeConfig.displayName = 'proto.pactus.FeeConfig';
}
...
proto.pactus.GetNodeInfoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    fee: (f = msg.getFee()) && proto.pactus.FeeConfig.toObject(includeInstance, f)
  };
...
proto.pactus.GetNodeInfoResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 14:
      ...
      break;
    case 15:
      var value = new proto.pactus.FeeConfig;
      reader.readMessage(value,proto.pactus.FeeConfig.deserializeBinaryFromReader);
      msg.setFee(value);
      break;
    default:
      reader.skipField();
...
proto.pactus.GetNodeInfoResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      15,
      f,
      proto.pactus.FeeConfig.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional FeeConfig fee = 15;
 * @return {?proto.pactus.FeeConfig}
 */
proto.pactus.GetNodeInfoResponse.prototype.getFee = function() {
  return /** @type{?proto.pactus.FeeConfig} */ (
    jspb.Message.getWrapperField(this, proto.pactus.FeeConfig, 15));
};


/**
 * @param {?proto.pactus.FeeConfig|undefined} value
 * @return {!proto.pactus.GetNodeInfoResponse} returns this
*/
proto.pactus.GetNodeInfoResponse.prototype.setFee = function(value) {
 ...
 * @return {!proto.pactus.GetNodeInfoResponse} returns this
 */
proto.pactus.GetNodeInfoResponse.prototype.clearFee = function() {
 ...
 * @return {boolean}
 */
proto.pactus.GetNodeInfoResponse.prototype.hasFee = function() {
 ...
 * @return {!Object}
 */
proto.pactus.FeeConfig.prototype.toObject = function(opt_includeInstance) {
  return proto.pactus.FeeConfig.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pactus.FeeConfig} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pactus.FeeConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.pactus.FeeConfig}
 */
proto.pactus.FeeConfig.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pactus.FeeConfig;
  return proto.pactus.FeeConfig.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pactus.FeeConfig} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pactus.FeeConfig}
 */
proto.pactus.FeeConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pactus.FeeConfig.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pactus.FeeConfig.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pactus.FeeConfig} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pactus.FeeConfig.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.pactus.FeeConfig.prototype.getFixedFee = function() {
...
/**
 * @param {number} value
 * @return {!proto.pactus.FeeConfig} returns this
 */
proto.pactus.FeeConfig.prototype.setFixedFee = function(value) {
  return jspb.Message.setProto3FloatField(this, 1, value);
};


/**
 * optional uint32 daily_limit = 2;
 * @return {number}
 */
proto.pactus.FeeConfig.prototype.getDailyLimit = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.pactus.FeeConfig} returns this
 */
proto.pactus.FeeConfig.prototype.setDailyLimit = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.pactus.FeeConfig.prototype.getUnitPrice = function() {
 ...
 * @return {!proto.pactus.FeeConfig} returns this
 */
proto.pactus.FeeConfig.prototype.setUnitPrice = function(value) {
