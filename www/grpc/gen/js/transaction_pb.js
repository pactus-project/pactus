...
proto.pactus.GetRawTransactionRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    transfer: (f = msg.getTransfer()) && proto.pactus.GetRawTransferTransactionRequest.toObject(includeInstance, f),
    bond: (f = msg.getBond()) && proto.pactus.GetRawBondTransactionRequest.toObject(includeInstance, f),
    unbond: (f = msg.getUnbond()) && proto.pactus.GetRawUnbondTransactionRequest.toObject(includeInstance, f),
    withdraw: (f = msg.getWithdraw()) && proto.pactus.GetRawWithdrawTransactionRequest.toObject(includeInstance, f)
  };
...
proto.pactus.GetRawTransactionRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.pactus.GetRawTransferTransactionRequest;
      reader.readMessage(value,proto.pactus.GetRawTransferTransactionRequest.deserializeBinaryFromReader);
      msg.setTransfer(value);
      break;
    case 4:
      var value = new proto.pactus.GetRawBondTransactionRequest;
      reader.readMessage(value,proto.pactus.GetRawBondTransactionRequest.deserializeBinaryFromReader);
      msg.setBond(value);
      break;
    case 5:
      var value = new proto.pactus.GetRawUnbondTransactionRequest;
      reader.readMessage(value,proto.pactus.GetRawUnbondTransactionRequest.deserializeBinaryFromReader);
      msg.setUnbond(value);
      break;
    case 6:
      var value = new proto.pactus.GetRawWithdrawTransactionRequest;
      reader.readMessage(value,proto.pactus.GetRawWithdrawTransactionRequest.deserializeBinaryFromReader);
...
proto.pactus.GetRawTransactionRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.pactus.GetRawTransferTransactionRequest.serializeBinaryToWriter
    );
  }
  f = message.getBond();
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.pactus.GetRawBondTransactionRequest.serializeBinaryToWriter
    );
  }
  f = message.getUnbond();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.pactus.GetRawUnbondTransactionRequest.serializeBinaryToWriter
    );
  }
...
/**
 * optional GetRawTransferTransactionRequest transfer = 3;
 * @return {?proto.pactus.GetRawTransferTransactionRequest}
 */
proto.pactus.GetRawTransactionRequest.prototype.getTransfer = function() {
  return /** @type{?proto.pactus.GetRawTransferTransactionRequest} */ (
    jspb.Message.getWrapperField(this, proto.pactus.GetRawTransferTransactionRequest, 3));
};


/**
 * @param {?proto.pactus.GetRawTransferTransactionRequest|undefined} value
 * @return {!proto.pactus.GetRawTransactionRequest} returns this
*/
...
/**
 * optional GetRawBondTransactionRequest bond = 4;
 * @return {?proto.pactus.GetRawBondTransactionRequest}
 */
proto.pactus.GetRawTransactionRequest.prototype.getBond = function() {
  return /** @type{?proto.pactus.GetRawBondTransactionRequest} */ (
    jspb.Message.getWrapperField(this, proto.pactus.GetRawBondTransactionRequest, 4));
};


/**
 * @param {?proto.pactus.GetRawBondTransactionRequest|undefined} value
 * @return {!proto.pactus.GetRawTransactionRequest} returns this
*/
...
/**
 * optional GetRawUnbondTransactionRequest unbond = 5;
 * @return {?proto.pactus.GetRawUnbondTransactionRequest}
 */
proto.pactus.GetRawTransactionRequest.prototype.getUnbond = function() {
  return /** @type{?proto.pactus.GetRawUnbondTransactionRequest} */ (
    jspb.Message.getWrapperField(this, proto.pactus.GetRawUnbondTransactionRequest, 5));
};


/**
 * @param {?proto.pactus.GetRawUnbondTransactionRequest|undefined} value
 * @return {!proto.pactus.GetRawTransactionRequest} returns this
*/
...
/**
 * optional GetRawWithdrawTransactionRequest withdraw = 6;
 * @return {?proto.pactus.GetRawWithdrawTransactionRequest}
 */
proto.pactus.GetRawTransactionRequest.prototype.getWithdraw = function() {
  return /** @type{?proto.pactus.GetRawWithdrawTransactionRequest} */ (
    jspb.Message.getWrapperField(this, proto.pactus.GetRawWithdrawTransactionRequest, 6));
};


/**
 * @param {?proto.pactus.GetRawWithdrawTransactionRequest|undefined} value
 * @return {!proto.pactus.GetRawTransactionRequest} returns this
*/
