...
goog.exportSymbol('proto.pactus.GetTransactionPoolRequest', null, global);
goog.exportSymbol('proto.pactus.GetTransactionPoolResponse', null, global);
 ...
 * @constructor
 */
proto.pactus.GetTransactionPoolRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pactus.GetTransactionPoolRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pactus.GetTransactionPoolRequest.displayName = 'proto.pactus.GetTransactionPoolRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.pactus.GetTransactionPoolResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.pactus.GetTransactionPoolResponse.repeatedFields_, null);
};
goog.inherits(proto.pactus.GetTransactionPoolResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pactus.GetTransactionPoolResponse.displayName = 'proto.pactus.GetTransactionPoolResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.pactus.GetTransactionPoolRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.pactus.GetTransactionPoolRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pactus.GetTransactionPoolRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pactus.GetTransactionPoolRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pactus.GetTransactionPoolRequest}
 */
proto.pactus.GetTransactionPoolRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pactus.GetTransactionPoolRequest;
  return proto.pactus.GetTransactionPoolRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pactus.GetTransactionPoolRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pactus.GetTransactionPoolRequest}
 */
proto.pactus.GetTransactionPoolRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pactus.GetTransactionPoolRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pactus.GetTransactionPoolRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pactus.GetTransactionPoolRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pactus.GetTransactionPoolRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPayloadType();
  if (f !== 0.0) {
    writer.writeEnum(
 ...
 * @return {!proto.pactus.PayloadType}
 */
proto.pactus.GetTransactionPoolRequest.prototype.getPayloadType = function() {
...
/**
 * @param {!proto.pactus.PayloadType} value
 * @return {!proto.pactus.GetTransactionPoolRequest} returns this
 */
proto.pactus.GetTransactionPoolRequest.prototype.setPayloadType = function(value) {
 ...
 * @const
 */
proto.pactus.GetTransactionPoolResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.pactus.GetTransactionPoolResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.pactus.GetTransactionPoolResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pactus.GetTransactionPoolResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pactus.GetTransactionPoolResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    txsList: jspb.Message.toObjectList(msg.getTxsList(),
    proto.pactus.TransactionInfo.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pactus.GetTransactionPoolResponse}
 */
proto.pactus.GetTransactionPoolResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pactus.GetTransactionPoolResponse;
  return proto.pactus.GetTransactionPoolResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pactus.GetTransactionPoolResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pactus.GetTransactionPoolResponse}
 */
proto.pactus.GetTransactionPoolResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pactus.GetTransactionPoolResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pactus.GetTransactionPoolResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pactus.GetTransactionPoolResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pactus.GetTransactionPoolResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.pactus.GetTransactionPoolResponse.prototype.getTxsList = function() {
  return /** @type{!Array<!proto.pactus.TransactionInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.pactus.TransactionInfo, 1));
};


/**
 * @param {!Array<!proto.pactus.TransactionInfo>} value
 * @return {!proto.pactus.GetTransactionPoolResponse} returns this
*/
proto.pactus.GetTransactionPoolResponse.prototype.setTxsList = function(value) {
 ...
 * @return {!proto.pactus.TransactionInfo}
 */
proto.pactus.GetTransactionPoolResponse.prototype.addTxs = function(opt_value, opt_index) {
 ...
 * @return {!proto.pactus.GetTransactionPoolResponse} returns this
 */
proto.pactus.GetTransactionPoolResponse.prototype.clearTxsList = function() {
