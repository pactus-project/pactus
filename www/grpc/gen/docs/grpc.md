...
<div id="toc-container">
  ...
  <li> Transaction Service
      <ul> 
        ...
        <li>
          <a href="#pactus.Transaction.GetTransactionPool">
          <span class="rpc-badge"></span> GetTransactionPool</a>
        </li>
        </ul>
    </li>
...
### GetTransactionPool <span id="pactus.Transaction.GetTransactionPool" class="rpc-badge"></span>

<p>GetTransactionPool retrieves current transactions on the TXPool.</p>

<h4>GetTransactionPoolRequest <span class="badge text-bg-info fs-6 align-top">Request</span></h4>
...
<table class="table table-bordered table-responsive table-sm">
  ...
  <h4>GetTransactionPoolResponse <span class="badge text-bg-warning fs-6 align-top">Response</span></h4>
