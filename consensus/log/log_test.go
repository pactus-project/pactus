...
func TestAddValidVote(t *testing.T) {
	...
	v3 := vote.NewCPPreVote(ts.RandHash(), h, r, 0, vote.CPValueYes, &vote.JustInitOne{}, valKeys[0].Address())
	v4 := vote.NewCPMainVote(ts.RandHash(), h, r, 0, vote.CPValueNo, &vote.JustInitOne{}, valKeys[0].Address())
