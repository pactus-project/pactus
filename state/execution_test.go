...
func TestExecuteBlock(t *testing.T) {
	...
	t.Run("Subsidy tx is invalid", func(t *testing.T) {
		...
		invBlock := block.MakeBlock(1, util.Now(), txIDs, tState1.lastBlockHash, tState1.validatorSet.CommitteeHash(), tState1.stateHash(), tState1.lastReceiptsHash, tState1.lastCommit, tState1.sortitionSeed, tState1.signer.Address())
