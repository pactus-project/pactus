...
type Config struct {
	Levels    map[string]string `toml:"Levels" comment:"Levels contians info,warning,error type.Default is info."`
	Colorfull bool              `toml:"Colorfull" comment:"Colorfull Output format can be enable or disable. Default is true."`
}
